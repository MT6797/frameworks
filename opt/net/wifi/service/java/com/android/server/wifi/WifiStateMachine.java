...
public class WifiStateMachine extends StateMachine implements WifiNative.WifiPnoEventHandler {
    ...
    */
    ...
    private static final int M_CMD_FACTORY_RESET             = BASE + 223;
     ...
     private static final int M_CMD_IP_REACHABILITY_MONITOR_TIMER        = BASE + 234;
    ...
    static public String smToString(int what) {
        ...
        switch (what) {
            ...
            case M_CMD_FACTORY_RESET:
                ...
                break;
            case M_CMD_IP_REACHABILITY_MONITOR_TIMER:
                s = "M_CMD_IP_REACHABILITY_MONITOR_TIMER";
                break;
            ///@}
            default:
            ...
            switch (message.what) {
              ...
              case DhcpStateMachine.CMD_POST_DHCP_ACTION:
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT:
                    ...
                    Log.d(TAG, "driver roaming, start to listen ip reachability lost for 10 sec, " +
