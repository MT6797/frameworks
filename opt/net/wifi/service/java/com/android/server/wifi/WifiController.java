        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case CMD_USER_PRESENT:
                    ...
                    mWifiStateMachine.setScreenLocked(false);
                    break;
                ...
                case CMD_SET_AP:
                    if (msg.arg1 == 1) {
                        ...
                        if (mShouldIgnoreCmdSetAp) {
                            Slog.d(TAG, "ignore CMD_SET_AP: " + CMD_SET_AP);
            ...
            switch (msg.what) {
                case CMD_WIFI_TOGGLED:
                    ...
                    if (! mSettingsStore.isWifiToggleEnabled() && mCmdSetApDefered) {
                        int uid = msg.arg2;
                        if (uid != EPDG_UID) {
                            Slog.d(TAG, "not ePDG wifi off, should ignore CMD_SET_AP");
                            mShouldIgnoreCmdSetAp = true;
                        } else {
                            Slog.d(TAG, "ePDG wifi off, no need to ignore CMD_SET_AP");
                            mShouldIgnoreCmdSetAp = false;
                        }
                ...
                case CMD_SET_AP:
                    if (msg.arg1 == 1) {
                        ...
                        Slog.d(TAG, "deferMsg CMD_SET_AP");
