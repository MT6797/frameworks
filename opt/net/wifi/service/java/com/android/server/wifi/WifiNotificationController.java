                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        if (intent.getAction().equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
                            ...
                            Slog.d(TAG, "Received NETWORK_STATE_CHANGED_ACTION, mNetworkInfo:" + mNetworkInfo);
            ...
            if (scanResults != null) {
                ...
                if (numOpenNetworks > 0) {
                    if (++mNumScansSinceNetworkStateChange >= NUM_SCANS_BEFORE_ACTUALLY_SCANNING) {
                        ...
                        Slog.d(TAG, "Supplicant state is " + supplicantState + " when interpret scan results.");
                ...
                Slog.d(TAG, "scanResults is null");
            }
        }
    ...
    private void setNotificationVisible(boolean visible, int numNetworks, boolean force,
        ...
        if (visible) {
            ...
            if (System.currentTimeMillis() < mNotificationRepeatTime) {
                Slog.d(TAG, "Not enough time has passed to show the notification again.");
                return;
            }
