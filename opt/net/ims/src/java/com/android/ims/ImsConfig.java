...
public class ImsConfig {
    ...
    */
    public static class ConfigConstants {
        ...
        /**
         * VoWiFi status for WFC/s status of Enabled (1), or Disabled (0).
         * Value is in Integer format.
         * Operator: Op06
         * Specification: R19.0.1, VoWiFi Provisioning utilising SMS
         */
        public static final int WFC_SETTING_ENABLED = 27;

        // Expand the operator config items as needed here, need to change
        // PROVISIONED_CONFIG_END after that.
        public static final int PROVISIONED_CONFIG_END = WFC_SETTING_ENABLED;
    }
