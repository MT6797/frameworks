...
public class SIMRecords extends IccRecords {
    ...
    */
    ...
    public void dispose() {
        ...
        if (DBG) log("Set disable CF icon because SIMRecords dispose.");
...
////        phone.setNetworkSelectionModeAutomatic(null);
    ...
    */
    ...
    public boolean isHPlmn(String plmn) {
        ...
        sst = ((PhoneBase) ((PhoneProxy) mPhone).getActivePhone()).getServiceStateTracker();
    ...
    void updatePHBStatus(int status, boolean isSimLocked) {
        if(!isRightPhone(getChildPhoneId(),"GSM")) {
            log("is not right phone.");
            return;
        }
