...
#define MM_LOGV(fmt, arg...)  ALOGV("[%s]line:%d "fmt, __FUNCTION__, __LINE__, ##arg)
#define MM_LOGD(fmt, arg...)  ALOGD("[%s]line:%d "fmt, __FUNCTION__, __LINE__, ##arg)
#define MM_LOGI(fmt, arg...)  ALOGI("[%s]line:%d "fmt, __FUNCTION__, __LINE__, ##arg)
#define MM_LOGW(fmt, arg...)  ALOGW("[%s]line:%d "fmt, __FUNCTION__, __LINE__, ##arg)
#define MM_LOGE(fmt, arg...)  ALOGE("[%s]line:%d "fmt, __FUNCTION__, __LINE__, ##arg)
#else
