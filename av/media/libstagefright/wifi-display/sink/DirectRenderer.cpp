...
void DirectRenderer::onRenderVideo() {
    ...
    //mediatype: true:video,false:audio;
        ...
        if ( offset != -1&& t1 != -1&& t2 != -1&& t4!= -1 && q1 != -1 && q2 != -1 && q4 != -1 && q6 != -1 && q7 != -1) {
            ...
            (mediaType? "video":"audio"),(long long)(timestamp / 1000),(long long)(t2-t1) ,(long long)(t4-t2),(long long)(q1-t4),
            (long long)(q2 - q1),(long long)(q4 - q2),(long long)(q6 -q4),(long long)(q7 - q6),(long long)(now/1000 - q7),(long long)(q7 - t1));
        }else if (q1 != -1 && q2 != -1 && q4 != -1 && q6 != -1 && q7 != -1){
            ALOGD("[%s][%lld]Partial   dr->mc %lld, dec %lld, dec->queOut %lld,  dr->rend %lld, rend %lld,     total %lld",
            (mediaType? "video":"audio"),(long long)(timestamp / 1000) ,(long long)(q2 - q1),(long long)(q4 - q2), (long long)(q6 -q4),(long long)(q7 - q6),
            (long long)(now/1000 - q7),(long long)(q7 - q1));
        }
}
