            ...
            bool                is_new_rgn)
{
    ...
    else /* New region */
    {
        ...
        DVB_LOG("DvbRegionMgr::parseSegment_impl() new region id=%d",this->ui1_id);
        DVB_SBTL_RCS_GET_RGN_WIDTH(pui1_data, ui2_rgn_width);
        DVB_SBTL_RCS_GET_RGN_HEIGHT(pui1_data, ui2_rgn_height);
        DVB_LOG("DvbRegionMgr::parseSegment_impl() new region width=%d",ui2_rgn_width);
        DVB_LOG("DvbRegionMgr::parseSegment_impl() new region height=%d",ui2_rgn_height);
#ifdef MW_SBTL_FORCE_4BIT_RGN_DEPTH
