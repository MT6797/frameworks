...
status_t SurfaceFlinger::captureScreen(const sp<IBinder>& display,
    ...
    public:
        ...
        virtual bool handler() {
            ...
            // When do rotation animation, system will capture a screenshot first. Then start
            // setting z-order of screenshot layer. However, this handler still lock the mutex.
            // Because transaction function need the mutex, the z-order can not be set immediately.
            // Therefore, screenshot layer may later appear in the screen.
            Mutex::Autolock _l(flinger->mStateLock);
#endif
