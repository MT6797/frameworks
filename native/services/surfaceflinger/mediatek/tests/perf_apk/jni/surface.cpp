...
#define LOGV(x, ...) ALOGV("[SFT_jni] " x, ##__VA_ARGS__)
#define LOGD(x, ...) ALOGD("[SFT_jni] " x, ##__VA_ARGS__)
#define LOGI(x, ...) ALOGI("[SFT_jni] " x, ##__VA_ARGS__)
#define LOGW(x, ...) ALOGW("[SFT_jni] " x, ##__VA_ARGS__)
#define LOGE(x, ...) ALOGE("[SFT_jni] " x, ##__VA_ARGS__)
