...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, String.format("[SFT] Surface Num = %d, isDefaultSize=%b, BufferWidth=%d, " +
                "BufferHeight=%d, BorderWidth=%d, FixedColor=%d",
        ...
        for (int i = 0; i < surfacenum; i++) {
            ...
            DrawingBoard view = new DrawingBoard(this, useDefaultSize, bufferWidth, bufferHeight,
                                            updateScreen, api, format, color);
            if (i == 0) {
            ...
            AbsoluteLayout.LayoutParams lp = new AbsoluteLayout.LayoutParams(
                //screenWidth - 2*BORDER_WIDTH*i, screenHeight - 2*BORDER_WIDTH*i,
        ...
        if (isEnalbeVirtualDisplay) {
            ...
            mVirtualBoard = new VirtualBoard(this, parser, viewWidth, viewHeight,
                                        isShowVirtualDisplay);
