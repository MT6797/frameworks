...
public class DrawingBoard extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public DrawingBoard(Context context,
        boolean useDefaultSize, int bufferWidth, int bufferHeight,
        boolean updateScreen, int api, int format, int colorIndex) {
        super(context);
...
//      systemUIVisibility = visibility;
    ...
    */
    ...
    private void connect(SurfaceHolder holder) {
        ...
        mId = SurfaceFlingerTest.connect(s, isDefaultSize, mBufferWidth, mBufferHeight,
                                        isUpdateScreen, mApi, mFormat, mColorIndex);
