...
public class JsonParser {
    ...
    public String getFrameArray(int idx, String key) {
        ...
        if (idx >= mFrameArray.length()) {
            Log.e(TAG, "[Json] Frame idx=" + idx +
                    " is too big than length " + mFrameArray.length());
            return r;
        }
    ...
    public String getVirtualDisplayFrameArray(int idx, String key) {
        ...
        if (idx >= mVirtualDisplayFrameArray.length()) {
            Log.e(TAG, "[Json] VirtualDisplayFrame idx=" + idx +
                    " is too big than length " + mVirtualDisplayFrameArray.length());
            return r;
        }
        ...
        try {
            ...
            if (object != null) {
                r = object.getString(key);
                Log.d(TAG, "[Json] getVirtualDisplayFrameArray[" + idx +
                        "], key:" + key + ", return:" + r);
            }
            else {
