...
public class VirtualBoard extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public VirtualBoard(Context context, JsonParser parser, int viewWidth,
        int viewHeight, boolean useSurfaceView) {
        super(context);
        ...
        if (useSurfaceView) {
            ...
            try {
                mImageReader = ImageReader.newInstance(mViewWidth, mViewHeight,
...
//      TestPresentation presentation = new TestPresentation(getContext(),
    ...
    private class TestPresentation extends Presentation {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (TEST_CASE == 0 || TEST_CASE == 1) {
                ...
                Log.i(TAG, String.format("[SFT] VirtualDisplay Layer Num = %d, isDefaultSize=%b," +
                        "BufferWidth=%d, BufferHeight=%d, BorderWidth=%d, FixedColor=%d",
...
//              SurfaceFlingerTest.setGlobalConfig(fixedColor);
                ...
                for (int i = 0; i < surfacenum; i++) {
                    ...
                    DrawingBoard view = new DrawingBoard(getContext(), useDefaultSize, bufferWidth,
                                                         bufferHeight, updateScreen, api,
                                                         format, color);
                    if (i == 0) {
                    ...
                    Log.i(TAG, String.format("[SFT] Virtual layout[%d], w=%d, h=%d, x=%d, y=%d",
                        i, w, h, x, y));
