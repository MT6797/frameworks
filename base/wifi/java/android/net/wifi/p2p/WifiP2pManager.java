...
public class WifiP2pManager {
    ...
    /** @hide */
    public static final int REMOVE_CLIENT                           = BASE + 110;
    /** @hide */
    public static final int REMOVE_CLIENT_FAILED                    = BASE + 111;
    /** @hide */
    public static final int REMOVE_CLIENT_SUCCEEDED                 = BASE + 112;

    /** @hide */
    public static final int STOP_P2P_FIND_ONLY                      = BASE + 113;
   ...
   /**
    ...
    ///M: crossmount  @{
    /** @hide */
    public static final int CROSSMOUNT_TAG     = 33333;

    /** Internal use only @hide */
    public void setCrossmountMode(int mode, int freq) {
        try {
            mService.setMiracastModeEx(mode, CROSSMOUNT_TAG + freq);
        } catch(RemoteException e) {
           // ignore
        }
    }
