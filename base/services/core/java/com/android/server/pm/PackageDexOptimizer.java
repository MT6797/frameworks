...
final class PackageDexOptimizer {
    ...
    private String createOatDirIfSupported(PackageParser.Package pkg, String dexInstructionSet)
        ...
        final boolean isVendorApps = (pkg.applicationInfo.flagsEx
                                        & ApplicationInfo.FLAG_EX_OPERATOR) != 0;
        if (((pkg.isSystemApp() || isVendorApps) && !pkg.isUpdatedSystemApp())
            || pkg.isForwardLocked() || pkg.applicationInfo.isExternalAsec()) {
            return null;
        }
