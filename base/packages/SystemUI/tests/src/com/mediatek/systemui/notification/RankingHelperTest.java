...
public class RankingHelperTest extends AndroidTestCase {
    ...
    public void setUp() {
        ...
        mNotiWithMaxPri = new Notification.Builder(getContext())
                ...
                .build();
        mRecordWithMaxPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, Notification.PRIORITY_MAX,
                mNotiWithMaxPri, user), 0);
        ...
        mNotiWithHighPri = new Notification.Builder(getContext())
                ...
                .build();
        mRecordWithHighPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, Notification.PRIORITY_HIGH,
                mNotiWithHighPri, user), 0);

        mNotiWithDefaultPri = new Notification.Builder(getContext())
                .setContentTitle("J")
                .setWhen(1203)
                .build();
        mRecordWithDefaultPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, Notification.PRIORITY_DEFAULT,
                mNotiWithDefaultPri, user), 0);
        ...
        mNotiWithLowPri = new Notification.Builder(getContext())
                ...
                .setWhen(1204)
                .build();
        mRecordWithLowPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, Notification.PRIORITY_LOW,
                mNotiWithLowPri, user), 0);
        ...
        mNotiWithMinPri = new Notification.Builder(getContext())
                ...
                .setWhen(1205)
                .build();
        mRecordWithMinPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, Notification.PRIORITY_MIN,
                mNotiWithMinPri, user), 0);

        mNotiWithAffinity = new Notification.Builder(getContext())
        .setContentTitle("M")
        .setWhen(1200)
        .build();
        mRecordWithAffinity = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, 0, mNotiWithAffinity, user), 0);
        ...
        .setWhen(1200)
        .build();
        mRecordWithAffinity2 = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, 0, mNotiWithAffinity2, user), 0);
        ...
        .setWhen(1200)
        .build();
        mRecordWithPkgPri = new NotificationRecord(new StatusBarNotification(
                "package", "package", 1, null, 0, 0, 0, mNotiWithPkgPri, user), 0);
