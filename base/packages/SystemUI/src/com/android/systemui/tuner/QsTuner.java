...
public class QsTuner extends Fragment implements Callback {
    ...
    private static int getLabelResource(String spec) {
        ...
        // M: Add extra tiles @{
        else if (spec.equals("audioprofile")) return R.string.audio_profile;
        else if (spec.equals("hotknot")) return R.string.quick_settings_hotknot_label;
        // @}
        return 0;
    }
    ...
    private static class CustomHost extends QSTileHost {
        ...
        public CustomHost(Context context) {
            ...
            super(context, null, null, null, null, null, null, null, null, null,
                    null, null, new BlankSecurityController(), null, null);
        }
        ...
        public void showAddDialog() {
            ...
            // M: add extra tiles
            String[] defaults = (getContext().getString(
                    R.string.quick_settings_tiles_default)
                    + "," + getContext().getString(
                    R.string.quick_settings_tiles_extra)).split(",");
    ...
    private static class DraggableTile extends QSTile<QSTile.State>
        ...
        private int getIcon() {
            ...
            // M: Add extra tiles @{
            else if (mSpec.equals("audioprofile")) return R.drawable.ic_qs_custom_on;
            else if (mSpec.equals("hotknot")) return R.drawable.ic_signal_hotknot_enable;
            // @}
