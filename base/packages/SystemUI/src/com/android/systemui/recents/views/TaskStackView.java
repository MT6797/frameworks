    ...
    public void startLaunchTaskAnimation(TaskView tv, Runnable r, boolean lockToTask) {
        ...
        for (int i = 0; i < taskViewCount; i++) {
            ...
            if (t == tv) {
                ...
                // M: [ALPS02406109]Add a judgment for no group in this task
                boolean occludesLaunchTarget = launchTargetTask.group == null ? false
                        : launchTargetTask.group.isTaskAboveTask(t.getTask(),
                                launchTargetTask);
