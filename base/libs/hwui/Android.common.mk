...
LOCAL_SRC_FILES += \
    ...
    mediatek/MTKTextureTracker.cpp \
    mediatek/MTKMonitorThread.cpp \
    mediatek/MTKDisplayListOp.cpp \
...
ifeq ($(strip $(MTK_GMO_RAM_OPTIMIZE)), yes)
    LOCAL_SRC_FILES += mediatek/MTKRenderProperties.cpp
...
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
    LOCAL_CFLAGS += -DMTK_USER_BUILD -DIS_USER_BUILD=true -DIS_USERDEBUG_BUILD=false -DIS_ENG_BUILD=false
else
    LOCAL_CFLAGS += -DMTK_DEBUG_RENDERER
    ifeq ($(strip $(TARGET_BUILD_VARIANT)), eng)
        LOCAL_CFLAGS += -DMTK_ENG_BUILD -DIS_USER_BUILD=false -DIS_USERDEBUG_BUILD=false -DIS_ENG_BUILD=true
    else
        LOCAL_CFLAGS += -DMTK_USERDEBUG_BUILD -DIS_USER_BUILD=false -DIS_USERDEBUG_BUILD=true -DIS_ENG_BUILD=false
    endif
endif
