...
void Dither::bindDitherTexture() {
    if (!mInitialized) {
        ...
        if (mCaches.extensions().hasFloatTextures()) {
            ...
            TT_ADD(mDitherTexture, DITHER_KERNEL_SIZE, DITHER_KERNEL_SIZE, GL_RED, GL_FLOAT,
                    "dither", "[Dither.cpp] bindDitherTexture +");
        } else {
            ...
            TT_ADD(mDitherTexture, DITHER_KERNEL_SIZE, DITHER_KERNEL_SIZE, GL_ALPHA, GL_UNSIGNED_BYTE,
                    "dither", "[Dither.cpp] bindDitherTexture +");
        }
