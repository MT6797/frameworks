...
public:
    ...
    bool dumpDisplayList(int width, int height, int frameCount, OpenGLRenderer* renderer);
    bool dumpDraw(int width, int height, int frameCount,
        int index, OpenGLRenderer* renderer, void* drawOp, int sub = 0);
    bool dumpLayer(int width, int height, int fbo,
        int frameCount, OpenGLRenderer* renderer, void* layer);
