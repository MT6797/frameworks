...
bool g_HWUI_DEBUG_OPENGL = true;
bool g_HWUI_DEBUG_EXTENSIONS = false;
bool g_HWUI_DEBUG_INIT = false;
bool g_HWUI_DEBUG_MEMORY_USAGE = false;
bool g_HWUI_DEBUG_CACHE_FLUSH = IS_ENG_BUILD;
bool g_HWUI_DEBUG_LAYERS_AS_REGIONS = false;
bool g_HWUI_DEBUG_CLIP_REGIONS = false;
...
bool g_HWUI_DEBUG_DEFER = false;
bool g_HWUI_DEBUG_DISPLAY_LIST = false;
bool g_HWUI_DEBUG_DISPLAY_LIST_OPS_AS_EVENTS = IS_ENG_BUILD;
bool g_HWUI_DEBUG_DETAILED_EVENTS = IS_ENG_BUILD;
bool g_HWUI_DEBUG_MERGE_BEHAVIOR = false;
...
bool g_HWUI_debug_texture_tracker = false;
bool g_HWUI_debug_render_properties = false;
bool g_HWUI_debug_continuous_frame = false;
bool g_HWUI_debug_current_frame = false;
...
void setDebugLog() {
    bool* pDebugArray[] = {
        ...
        &g_HWUI_DEBUG_DISPLAY_LIST_OPS_AS_EVENTS,
    ...
    const char* properties[] = {
        ...
        "debug.hwui.log.current_frame",      // log current frame
