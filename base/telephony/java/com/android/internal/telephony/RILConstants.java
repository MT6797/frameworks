...
*/
    ...
    int RIL_REQUEST_SET_VOLTE_ENABLE = (RIL_REQUEST_VENDOR_BASE + 168);
    int RIL_REQUEST_SET_WFC_ENABLE = (RIL_REQUEST_VENDOR_BASE + 169);
    int RIL_REQUEST_SET_IMS_VOICE_ENABLE = (RIL_REQUEST_VENDOR_BASE + 170);
    int RIL_REQUEST_SET_IMS_VIDEO_ENABLE = (RIL_REQUEST_VENDOR_BASE + 171);
    /// @}

    /// M: IMS ViLTe feature. @{
    int RIL_REQUEST_VT_DIAL_WITH_SIP_URI = (RIL_REQUEST_VENDOR_BASE + 172);
    /// @}

    /// M: ECC change feature for single SIM project. @{
    int RIL_REQUEST_SWITCH_MODE_FOR_ECC = (RIL_REQUEST_VENDOR_BASE + 173);
    /// @}
    ...
    /// M: MAL @{
    int RIL_UNSOL_RADIO_CAPABILITY_SWITCH_START = (RIL_UNSOL_VENDOR_BASE + 102);
    /// @}
