...
public class SoterKeyStoreKeyPairRSAGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    private void initAlgorithmSpecificParameters() throws InvalidAlgorithmParameterException {
        ...
        if (algSpecificSpec instanceof RSAKeyGenParameterSpec) {
            Log.i(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.initAlgorithmSpecificParameters: starting initing RSAKeyGenParameterSpec");
    ...
    private void addAlgorithmSpecificParameters(KeymasterArguments keymasterArgs) {
        ...
        if (isAutoSignedWithCommonkWhenGetPublicKey) {
            ...
            if (!TextUtils.isEmpty(mAutoSignedKeyNameWhenGetPublicKey)) {
                ...
                keymasterArgs.addBytes(KeymasterDefs.KM_TAG_SOTER_AUTO_SIGNED_COMMON_KEY_WHEN_GET_PUBLIC_KEY,
                        (Credentials.USER_PRIVATE_KEY + mAutoSignedKeyNameWhenGetPublicKey).getBytes());
            }
        }
    ...
    private X509Certificate generateSelfSignedCertificate(
        ...
        Log.d(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.generateSelfSignedCertificate");
        String signatureAlgorithm =
                getCertificateSignatureAlgorithm(mKeymasterAlgorithm, mKeySizeBits, mSpec);
        if (signatureAlgorithm == null) {
            Log.d(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.generateSelfSignedCertificate: signatureAlgorithm is null");
            ...
            try {
                Log.d(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.generateSelfSignedCertificate: generateSelfSignedCertificateWithValidSignature");
                ...
                // generation failing.
                Log.d(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.generateSelfSignedCertificate: generateSelfSignedCertificateWithFakeSignature");
                return generateSelfSignedCertificateWithFakeSignature(publicKey);
            }
        }
    }
    ...
    private byte[] getRealKeyBlobByKeyName(String keyName) {
        Log.d(SoterUtil.TAG, "SoterKeyStoreKeyPairRSAGeneratorSpi.getRealKeyBlobByKeyName: keyName = " + keyName);
