...
int register_android_graphics_BitmapFactory(JNIEnv* env) {
    ...
    gOptions_preferSizeFieldID = GetFieldIDOrDie(env, options_class, "inPreferSize", "I");
    ...
    gOptions_dynamicConFieldID = GetFieldIDOrDie(env,options_class,"inDynamicCon","[I");
    gOptions_dynamicConflagFieldID = GetFieldIDOrDie(env, options_class, "inDynmicConFlag", "Z");
