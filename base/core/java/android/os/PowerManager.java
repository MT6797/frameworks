...
public final class PowerManager {
    ...
    /**
     * Mediatek customization for power saving mode
     * @hide
     */
    public static final int POWER_HINT_POWER_SAVING = 0x00000101;

    /**
     * Mediatek customization for performance boost mode
     * @hide
     */
    public static final int POWER_HINT_PERFORMANCE_BOOST = 0x00000102;

    /**
     * Mediatek customization for balance mode
     * @hide
     */
    public static final int POWER_HINT_BALANCE = 0x00000103;
   ...
   /**
    ...
    /**
     * Power hint for power/performance policy swtich
     * <p>
     * Requires the {@link android.Manifest.permission#DEVICE_POWER} permission.
     * </p>
     *
     * @param hintId The policy user want to change
     * @param data not used
     *
     * @hide
     */
