...
public class UserManager {
    ...
    /// M: Add a Feature Option : MTK_ANDROID_FOR_WORK_SUPPORT for
    // managed user feature. @{
    private static final boolean FEATURE_MTK_AFW_SUPPORT = SystemProperties.get(
            "ro.mtk_afw_support", "").equals("1");
    /// @}
    ...
    public static int getMaxSupportedUsers() {
        ...
        int maxUserCnt = SystemProperties.getInt("fw.max_users",
                Resources.getSystem().getInteger(R.integer.config_multiuserMaximumUsers));
        /// M: Add a Feature Option : MTK_ANDROID_FOR_WORK_SUPPORT for
        // managed user feature. @{
        return FEATURE_MTK_AFW_SUPPORT ? (maxUserCnt >= 2 ? maxUserCnt : 2) : maxUserCnt;
        /// @}
    }
