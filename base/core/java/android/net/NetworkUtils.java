...
public class NetworkUtils {
    ...
    */
     ...
     */
    //return pid if startDhcpv6 successfully, else return = -1
    public native static int startDhcpv6(String interfaceName);
    public native static boolean startDhcpv6Renew(String interfaceName, int pid);
    public native static boolean getDhcpv6Results(String interfaceName, DhcpResults dhcpResults,
            int isrenew);
