...
public class KernelCpuSpeedReader {
    ...
    private static final String sProcFileCpu4 =
    ...
    public long[] readDelta() {
        ...
        try {
            fileReader = new FileReader(sProcFile);
            Slog.v(TAG, "cpu0 time_in_state exist.");
        } catch (FileNotFoundException e1) {
            Slog.v(TAG, "cpu0 time_in_state not exist, read cpu4 time_in_state...");
            try {
                fileReader = new FileReader(sProcFileCpu4);
                Slog.v(TAG, "cpu4 time_in_state exist.");
            } catch (FileNotFoundException e2) {
                Slog.e(TAG, "cpu4 time_in_state not exist, is it a BUG??!!");
