...
public final class FloatingToolbar {
    ...
    public FloatingToolbar show() {
        ...
        // If view port changes, need to relayout the items on the floating action mode.
        // Refer to ALPS02329993 for issue details.
        if (!isCurrentlyShowing(menuItems) || mWidthChanged || mPopup.viewPortHasChanged()) {
            mPopup.dismiss();
