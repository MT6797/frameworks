...
public interface IPerfServiceWrapper {
    ...
    public static final int SCN_120HZ_DISPLAY   = 8;
    public static final int SCN_SW_LEVEL_BOOST  = 9;
    public static final int SCN_RUNTIME_BOOST   = 10;
    public static final int SCN_MAX             = 11; /* should be (last scenario + 1) */
    ...
    public static final int CMD_SET_WIPHY_CAM               = 170;
