...
public class MobileManagerUtils {
    ...
    private static final boolean PRINT_DEBUG_BACKTRACE =
        SystemProperties.getInt("persist.moms.debug.backtrace", 0) == 1 ;
    ...
    public static boolean isSupported() {
        /// [ALPS02278077] We add a system property for turning off/on MoMs dynamically.
        boolean DISABLE_CTA_FOR_TEST =
            SystemProperties.getInt("persist.sys.mtk.disable.moms", 0) == 1;
        return FEATURE_SUPPORTED && !DISABLE_CTA_FOR_TEST;
    }
    ...
    private static void printDebugBacktrace() {
        if (PRINT_DEBUG_BACKTRACE) {
            // print call stack for debug
